...
public class CustomExceptionHandler {
    ...
    @ResponseBody
    public CustomJSONResult returnMaxUploadSizeException(MaxUploadSizeExceededException e) {
        e.printStackTrace();
        return CustomJSONResult.exception(ResponseStatusEnum.FILE_MAX_SIZE_500KB_ERROR);
    }
